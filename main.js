...
// find the index of the bad word and replace it to a proper word
...
// check if there are words longer than 10 characters

let lengthCheck = storyWords.every((word) => {
  return word.length < 10;
});
//console.log(lengthCheck);
// find the word that is longer and replace it with shorter word
